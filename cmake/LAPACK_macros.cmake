...
FUNCTION( CHECK_OPENBLAS INSTALL_PATH CMAKE_FILE )
    ...
    SET( BLAS_LAPACK_LINK ${OPENBLAS_LIBRARY} PARENT_SCOPE )
ENDFUNCTION()
...
FUNCTION( CHECK_LAPACK INSTALL_PATH CMAKE_FILE )
    ...
    ENDIF()
    IF ( LAPACK_LIB )
        FIND_MULTIPLE_LIBRARIES( LAPACK_LIBS "${INSTALL_PATH}" ${LAPACK_LIB} )
    ELSE()
        FIND_MULTIPLE_LIBRARIES( LAPACK_LIBS "${INSTALL_PATH}" lapack )
    ENDIF()

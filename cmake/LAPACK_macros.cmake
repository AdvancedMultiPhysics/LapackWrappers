...
FUNCTION( CHECK_ONEAPI INSTALL_PATH )
    ...
    ELSE()
        # Find MKL using find_package This needs more testing but should result in the targets being availible There are issues with the executable failing Need to add targets for
        # every package eventually
...
FUNCTION( CHECK_OPENBLAS INSTALL_PATH )
    VERIFY_PATH( "${INSTALL_PATH}" )
    IF ( NOT EXISTS "${INSTALL_PATH}/lib" )
        RETURN()
    ENDIF()
...
FUNCTION( CHECK_CRAY_LIBSCI INSTALL_PATH )
    ...
    FIND_MULTIPLE_LIBRARIES( CRAY_LIBSCI_LIBS "${CRAY_LIBSCI_LIB_DIR}" sci_${compiler} sci_amd sci_gnu sci_cray )
...
FUNCTION( CHECK_LAPACK INSTALL_PATH )
...
FUNCTION( CHECK_DEFAULT INSTALL_PATH )
    IF ( NOT BLAS_DIR )
    ...
    ENDIF()
    SET( BLAS_LAPACK_LINK "-Wl,--no-as-needed -Wl,--start-group ${BLAS_LIBS} ${LAPACK_LIBS} -Wl,--end-group" )
    STRING( REPLACE ";" " " BLAS_LAPACK_LINK "${BLAS_LAPACK_LINK}" )

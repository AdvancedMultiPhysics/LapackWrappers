...
ELSEIF ( LAPACK_VENDOR MATCHES "MKL" )
    ...
    FILE( APPEND "${LAPACK_OUT}" "SET(MKL_DIR \"${LAPACK_INSTALL_DIR}\")\n" )
    FILE( APPEND "${LAPACK_OUT}" "SET(MKL_DIRECTORY \"${LAPACK_INSTALL_DIR}\")\n" )
...
ELSEIF ( LAPACK_VENDOR MATCHES "CRAY-LIBSCI" )
    FILE( APPEND "${LAPACK_OUT}" "SET(USE_USE_CRAY_LIBSCI true)\n" )
    FILE( APPEND "${LAPACK_OUT}" "SET(USE_CRAY_LIBSCI_DIR \"${INSTALL_PATH}\")\n" )
    FILE( APPEND "${LAPACK_OUT}" "SET(USE_CRAY_LIBSCI_DIRECTORY \"${INSTALL_PATH}\")\n" )
    FILE( APPEND "${LAPACK_OUT}" "SET( CMAKE_INSTALL_RPATH $\{CMAKE_INSTALL_RPATH} \"${INSTALL_PATH}/lib\" )\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#include \"${LAPACK_INCLUDE_DIRS}/cblas.h\"\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#include \"${BLAS_INCLUDE_DIRS}/lapacke.h\"\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#ifndef USE_BLAS\n #define USE_BLAS\n #endif\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#ifndef USE_LAPACK\n #define USE_LAPACK\n #endif\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#ifndef USE_CRAY_LIBSCI\n #define USE_CRAY_LIBSCI\n #endif\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#ifndef USE_CBLAS\n #define USE_CBLAS\n #endif\n" )

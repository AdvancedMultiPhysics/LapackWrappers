...
#
# find_package( FindCoverage [REQUIRED]             # Fail with error if the cppcheck is not found )
#
# This module finds headers and requested component libraries for the TPLs that were installed by the builder.
#
# COVERAGE_FOUND            - True if coverage was found COVERAGE_FLAGS             - Compiler flags for coverage COVERAGE_LIBS              - Coverage libraries
...
IF ( NOT GCOV_LIB )
    ...
    ENDIF()
ENDIF()
# IF ( NOT GCOV_LIB AND ";${languages};" MATCHES ";Fortran;" ) SET( GCOV_LIB ) SET( CMAKE_REQUIRED_FLAGS "${CMAKE_Fortran_FLAGS} ${COVERAGE_FLAGS} -lgcov" )
# CHECK_Fortran_SOURCE_COMPILES( "       program hello\n       end program hello\n" lgcov-fortran ) IF ( lgcov-fortran ) SET( GCOV_LIB -lgcov ) ENDIF() ENDIF()
IF ( GCOV_LIB )
